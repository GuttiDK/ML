    ...
    public partial class MLDropoutRisk
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"gender", @"gender", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"gender",@"age",@"academic_year",@"study_hours_per_day",@"exam_pressure",@"academic_performance",@"stress_level",@"anxiety_score",@"depression_score",@"sleep_hours",@"physical_activity",@"social_support",@"screen_time",@"internet_usage",@"financial_stress",@"family_expectation",@"burnout_score",@"mental_health_index"}))      
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=3231,MinimumExampleCountPerLeaf=24,LearningRate=0.025889870477865447,LabelColumnName=@"dropout_risk",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.48869157311521066,FeatureFraction=0.8006066050550144,L1Regularization=2E-10,L2Regularization=0.025460445318163737},MaximumBinCountPerFeature=362}));
